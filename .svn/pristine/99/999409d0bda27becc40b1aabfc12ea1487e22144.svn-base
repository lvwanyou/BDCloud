	...
	*/
	...
	var handleSidebarCollapse = function () {
        ...
        if ($.cookie('mini_sidebar') === '1') {
			...
			/* For sidebar */
			jQuery('#sidebar').addClass("mini-menu");
			window.parent.frames['mfr'].cols = "50,*";
			jQuery('#sidebar_img').attr("src",basePath+"template/img/zk.png");
			//jQuery('#main-content').addClass("margin-left-50");
			collapsed = true;
        }
		...
		jQuery('.sidebar-collapse').click(function () {
			...
			if(is_mobile && !(is_mini_menu)){
				...
				if(collapsed){
					...
					window.parent.frames['mfr'].cols = "203,*";
					jQuery('#sidebar_img').attr("src",basePath+"template/img/zd.png");
