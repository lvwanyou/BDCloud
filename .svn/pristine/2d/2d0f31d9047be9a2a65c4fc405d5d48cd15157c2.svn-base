...
<%@page import="com.xl.cloud.bean.Involve_Unit"%>
...
<style>
<%Involve_Unit caseinfo = (Involve_Unit)request.getSession().getAttribute("caseinfo2"); 
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<%-- 				<td>${result.name }</td>
								...
								<td><%= caseinfo.getSusUnit()%></td>
								<td><%= caseinfo.getRegion()%></td>
