	...
	b.prototype = {
		...
		top_animate:function(){
			...
			t.t.animate({top:(-t.height+t.hide)},300,function(){
				...
				$("#callout").click(function(){t.t.stop(true).animate({top:0},300);})
				$("#callout1").click(function(){t.t.stop(true).animate({top:0},300);})
			});
		},
		left_animate:function(){
			...
			t.t.animate({left:(-t.width+t.hide)},300,function(){
				...
				$("#callout").click(function(){t.t.stop(true).animate({left:0},300);})
				$("#callout1").click(function(){t.t.stop(true).animate({left:0},300);})
			});
		},
		right_animate:function(){
			...
			t.t.animate({left:(t.w_width-t.hide)},300,function(){
				...
				$("#callout").click(function(){t.t.stop(true).animate({left:t.w_width-t.width},300);})
				$("#callout1").click(function(){t.t.stop(true).animate({left:t.w_width-t.width},300);})
			});
		}
	};
	var y = {
