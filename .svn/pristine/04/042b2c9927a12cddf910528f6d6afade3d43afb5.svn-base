...
<body>
		...
		<div class="panel panel-default">
		  <div class="panel-heading">选择案件</div>
			...
			<div class="panel-body">
				<div class="form-group" style="float: left;margin-left: 20px;margin-bottom:0px;">
					<span class="alcenter" style="float: left;line-height：30px;">已选案件：</span>
					...
					<div class="panel-body" style="width: 100%; height: 100%;">
						<div class="panel-body" style="width: 100%">
							<input id="caseinfo" name="caseinfo" class="form-control" placeholder="搜索案件名称/案件编号" type="text"
								style="float: left; width: 75%;" onkeydown="onKeyDown_huadan(event)"/>

							<button type='button' class="btn btn-info" style="width: 55px; margin-left: 10px; height: 34px" onclick="showcase()">搜索</button>
						</div>
						
						<div class="panel-body" style="height: 60%;overflow-y: scroll;">
							<table id="datatable" class="table table-hover br004">
								<tbody id="tbcont">
									<tr>
						...
						<button type='button' class="btn btn-info" style="width: 70px; height: 34px; margin-left: 40%; margin-top: 3%"
							onclick="checkCase();">选择</button>
					</div>
				</div>
			</div>
	<div class="row" style="height:; width: 98%; margin-left: 1%;">
		<div class="panel panel-default">
		<div class="panel panel-default">
				<div class="find_nav">
					<div class="find_nav_left">
						<div class="find_nav_list">
							<ul style="">
								<li class="find_nav_cur "><a href="javascript:void(0)" onclick="d1()">通话次数分析</a></li>
		...
		<div id="d1" style="width:100%;">
				<div class="panel-body" style="width:100%;padding-top:0px;">
					<form class="form-inline" role="form" id="searchForm"
						...
						<div class="form-group">
							<a id="url1" href="javascript: void(0);"><div class="btn btn-info" style="width:80px;"onclick="showAllTicket(1)">执行分析</div></a>
							&nbsp;&nbsp;
							<a id="url12" href="javascript: void(0);"><div class="btn btn-info" style="width:80px;"onclick="exportFile()">导出结果</div></a>
						</div>

					</form>
				</div>
		
				<div class="panel panel-default" style="height:360px;width:47%;float:left;margin-right:2%;">
					<div class="panel-heading">通话次数TOP10</div>

					<div class="panel-body" style="padding-top: 0px;height: 300px;">
				...
				<div class="panel panel-default" style="position:relative; height:360px; overflow:auto;width:47%;float:left;" >
	...
	<div id="d2">
		<div class="panel panel-default">
			...
			<div class="panel-body">
					<div style="margin-left:12px;">
						<form style="margin-bottom:10px;" class="form-inline" role="form" id="searchForm" action="<%=basePath%>admin/getEvidence.php" method="post">
						<input type="hidden" name="pageno" id="pageno"/>
								
						<div class="form-group">
							<label for="" class="clabel">日期范围:</label>
									<input id="startDate222" name="startDate" 
											class="form-control" placeholder="请输入起始时间" type="text" style="width:150px;" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'endDate\')||\'new Date()\'}'});"/> 	
											<label for="" class="">至</label>
									<input id="endDate222" name="endDate" 
										    class="form-control" placeholder="请输入结束时间" type="text" style="width:150px;" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'startDate\')}',maxDate:new Date()});"/>
						</div>
								
								<div class="form-group">
									<label for="" class="clabel">嫌疑人姓名/手机号:</label>
									<input id="xingmingshouji" name="xingmingshouji" value="" 
										class="form-control" placeholder="请输入..." type="text" style="width:200px;"/>
								</div>
								
								<button type="button" class="btn btn-info" style="width:55px;" onclick="ContactAnalysis()">搜索</button>
								<a id="url13" href="javascript: void(0);"><div class="btn btn-info" style="width:80px;"onclick="exportFile_div2()">导出</div></a>
						</form>
					</div>
			...
			<div class="panel-body">
					<div style="margin-bottom:10px;">
						<form class="form-inline" role="form" id="searchForm" action="<%=basePath%>admin/getEvidence.php" method="post">
								...
								<div class="form-group">
									<label for="" class="clabel">共同联系人手机号:</label>
									<input id="gongtong" name="gongtong" value="" class="form-control" placeholder="请输入..." type="text" style="width:160px;"/>
								</div>
								
								<button type="button" class="btn btn-info" style="width:55x;" onclick="ContactAnalysis()">搜索</button>
								<!-- <a id="url" href="javascript: void(0);"><button type="button2" class="btn btn-info" style="width:80px;" onclick="exportDoc()" >导出</button></a> -->
								<!-- <a id="url" href="javascript: void(0);"><div  class="btn btn-info" style="width:80px;" onclick="exportDoc()">选择嫌疑人</div></a> -->
						</form>
					</div>
				...
				<div class="panel panel-default" style="height:520px;">
					<table id="datatable" class="table table-striped table-hover" style="text-align: center; border-bottom: 1px solid #DDDDDD;">
						<thead>
							<tr>
								<th style="text-align: left">对方号码</th>
								<th style="text-align: left">通话总次数</th>
							</tr>
						</thead>
						<tbody id="tbcont555">
		...
		<div class="panel panel-default" style="width: 50%;float: right;height: 520px;">
			<div class="panel-heading">共同联系人关系图</div>
			<div class="panel-body">
				<div id="main_d22" style="width: 100%; height: 450px;overflow-y :auto;"></div>
				</div>
				</div>	
		...
		<div id="d3" style="margin-top:20px;">
				<div class="panel-body" style="width:100%;">
					<form class="form-inline" role="form" id="searchForm"
						...
						<a id="url1" href="javascript: void(0);" class="btn btn-info" onclick="Ticket111()">执行统计</a>
					</form>
				</div>
			<div class="col-md-5"  style="width:33%;">
				<div class="panel panel-default" >
					...
					<div class="panel-body" style="">
						<div id="mains" style="width: 100%; height: 250px;margin-top: 20px;"></div>
					</div>
		...
		<div id="d4">
			...
			<form class="form-inline col-md-offset-1" role="form" id="searchForm" style="margin-left:0px;margin-bottom:5px"
						action="" method="post">
						<input type="hidden" name="pageno" id="pageno" />
						<div class="form-group">
							<label for="" class="">日期范围:</label>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   <label for="" class="">时间段范围:</label>
						<input type="text" id="startTime_d4" value="00:00" onfocus="WdatePicker({dateFmt:'HH:mm'})" class="form-control" style="width:100px"/>
						&nbsp;&nbsp;<label for="" class="">至</label>
						<input type="text" id="endTime_d4" value="23:59" onfocus="WdatePicker({dateFmt:'HH:mm'})" class="form-control" style="width:100px"/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<!-- 嫌疑人手机号：<input id="suspectNums_d4" class="form-control" placeholder="请输入..." /> -->
									<label for="" class="">选择嫌疑人:</label>
										<select class="form-control" style="width: 150px; " id="select_d4">
											
										</select>
						</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<button type="button" class="btn btn-info" style="width:55px;" onclick="contactMap(1)">搜索</button>
					</form>
        ...
        <%-- <a href="<%=basePath%>template/baidu_map/baidu_map_demo.html" target="_blank">444</a>
         <a href="<%=basePath%>template/baidu_map/test.jsp" target="_blank">555</a> --%>
       </div>
       <script type="text/javascript">  
  // 百度地图API功能，显示离线地图
	var map = new BMap.Map("container", {minZoom:2,maxZoom:12});    // 创建Map实例
...
//点击地名显示对应地点
function searchByLatAndLon(lat,lon){
	//	alert(lat+"--"+lon);
...
function searchByStationName(addr) {
    ...
    localSearch.search(keyword);
       ...
       <div class="col-md-6">
		...
		<div id="d5">
		<form class="form-inline col-md-offset-3" role="form" id="searchForm" style="margin-left:0px;margin-bottom:5px"
						action="" method="post">
						&nbsp;&nbsp;<input type="hidden" name="pageno" id="pageno" />
						<div class="form-group">
							<label for="" class="clabel">日期范围:</label>
						...
						<div class="form-group">
								<label for="" class="clabel">通话次数:</label>
								<input id="tonghuacishu" name="tonghuacishu" value="" onkeydown="onKeyDown_d7(event)"										class="form-control" placeholder="请输入..." type="text" style="width:160px;"/>

						</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						
						<button type="button" class="btn btn-info" style="width:55px;" onclick="ContactAnalysis_d5()">搜索</button>
							<!-- <button type="button" class="btn btn-info" style="width:80px;margin-left=30px;" onclick="Exporthd_each()">导出结果</button> -->
							
					</form>
		<div class="col-md-12" id="xianghutonghua">
				...
				<div class="panel panel-default">
					...
					<div id="main_d5" class="b39" style="height:400px;display:;">
					
					</div>
					<div id="main_d52" class="b39" style="height:800px;display:none;">
						...
						<div class="form-group">
							<label for="" class="">日期范围:</label>
									<input id="startDate_d6" name="startDate" 
											class="form-control" placeholder="请输入起始日期" type="text" style="width:130px;" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'endDate\')||\'new Date()\'}'});"/> 	
									<label for="" class="">至</label>
									<input id="endDate_d6" name="endDate" 
										    class="form-control" placeholder="请输入结束日期" type="text" style="width:130px;" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'startDate\')}',maxDate:new Date()});"/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label for="" class="">时间段范围:</label>
						<input type="text" id="startTime_d6" value="20:00" onfocus="WdatePicker({dateFmt:'HH:mm'})" class="form-control" style="width:100px"/>
						&nbsp;&nbsp;<label for="" class="">至</label>
						<input type="text" id="endTime_d6" value="08:00" onfocus="WdatePicker({dateFmt:'HH:mm'})" class="form-control" style="width:100px"/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<!-- 嫌疑人手机号：<input id="suspectNums_d6" class="form-control" placeholder="请输入..." /> -->
									<label for="" class="">选择嫌疑人:</label>
									<select class="form-control" style="width: 150px; margin-left: 16px;" id="select_d6">
										
									</select>
						</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<button type="button" class="btn btn-info" style="width:55px;" onclick="addressMap(1)">搜索</button>
					</form>
		<!-- ///////////////////疑似居住地地图显示/////////////////////////////////////////// -->
		<div style="margin:auto;" class="col-md-12">   
       ...
       <script type="text/javascript">
   	var map_d6 = new BMap.Map("container_d6", {minZoom:2,maxZoom:12});
	var point_d6 = new BMap.Point(116.404, 39.915);//默认中心位置，北京
	map_d6.centerAndZoom(point_d6, 8);
	map_d6.enableScrollWheelZoom(true);     //开启鼠标滚轮缩放
	map_d6.addControl(new BMap.NavigationControl());   //缩放按钮
	
	 function init_for_d6(){
		
		map.clearOverlays();//清空原来的标注	
	//	addrs.push(39.5040407056+"-"+116.6857910156);
	//	addrs.push(39.915+"-"+116.404)
  	   for(var i=0;i<addrs.length;i++){
  		 if(i==0)	//默认通话字数最多的位置为中心位置
  			map_d6.centerAndZoom(new BMap.Point(addrs[0].split("-")[1], addrs[0].split("-")[0]), 8);
  		   lat=addrs[i].split("-")[0];
  		   lon=addrs[i].split("-")[1]; 	
  		point_d6 = new BMap.Point(lon,lat);
  		marker_d6 = new BMap.Marker(point_d6);  // 创建标注
  		map_d6.addOverlay(marker_d6);               // 将标注添加到地图中
  		marker_d6.setAnimation(BMAP_ANIMATION_BOUNCE); //跳动的动画
  	   }
				...
				<div class="col-md-10" style="width:100%;">
					...
					<div style="margin-top:20px;">
						<form class="form-inline" role="form" id="searchForm" action="<%=basePath%>admin/getEvidence.php" method="post">
							...
							<div class="form-group">
								<label for="" class="clabel">通话日期:</label>
								<input id="startTime_1" name="startTime_1" onkeydown="onKeyDown_d7(event)"
									   class="form-control" placeholder="请输入开始时间" type="text" style="width:130px;" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'startDate\')}',maxDate:new Date()});"/>
							</div>
							<div class="form-group">
								<label for="" class="">至</label>
								<input id="endTime_1" name="endTime_1" onkeydown="onKeyDown_d7(event)"
									   class="form-control" placeholder="请输入结束时间" type="text" style="width:130px;" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'startDate\')}',maxDate:new Date()});"/>
							</div>
							<div class="form-group">
								<label for="" class="clabel">嫌疑人姓名/手机号:</label>
								<input id="StatisticsSuspectName" name="StatisticsSuspectName" value="" onkeydown="onKeyDown_d7(event)"										class="form-control" placeholder="请输入..." type="text" style="width:160px;"/>

							</div>
							<div class="form-group">
								<label for="" class="clabel">对方号码:</label>
								<input id="StatisticsContactorNumber" name="StatisticsContactorNumber" value="" onkeydown="onKeyDown_d7(event)"
										class="form-control" placeholder="请输入..." type="text" style="width:160px;"/>
							</div>
							<button type="button" class="btn btn-info" style="width:55px;" onclick="showAllTicket(1)">搜索</button>
							<a id="url12_d5" href="#"><div class="btn btn-info" style="width:80px;"onclick="Exporthd_each()">导出数据</div></a>
				...
				<div class="panel panel-default" style="margin-top: 20px;">
					...
					<div class="panel-body" style="padding: 0 0 15px;">
						...
						<table id="datatable" class="table table-striped table-hover" style="text-align: center; border-bottom: 1px solid #DDDDDD;">
							<thead>
								 <tr>
									<th id="startTime" name="startTime">通话时间</th>
									<th  id="name" name="name">嫌疑人姓名</th>
									<th  id="localNum" name="localNum">嫌疑人号码</th>
									<th  id="dialNumber" name="dialNumber">对方号码</th>
									<th  id="callDuration" name="callDuration">通信时长</th>
									<th  id="position" name="position">通信地点</th>
									<th id="method" name="method">通信类型</th>
								</tr>
							</thead>
							<tbody id="tbcont20">
						...
						<div class="alcenter" style="font-size: 14px">
							...
							<div class="pagebar inline" style="position: absolute; right: 142px; height: 29px;">
								<ul class="pagination pagination-sm" style="margin: 0;">
							...
							<div style="float: right;margin-right: 11px;">
								<input class="form-control" type="text" style="width:58px;height:28px;border-radius:2px; display: inline;" id="givePages_huadanfenxi_button" name="givePages_huadanfenxi_button" onkeydown="onKeyDown_fenxi(event)"/>
								<button type="button" class="btn" onclick="showAllTicket(1)" style="width:52px;height:28px;line-height: 12px;">跳转</button>
							</div>
						</div>
					</div>
				</div>
	...
	//var caseidhuadan = ${caseid };	
	var allphone = '<%=request.getAttribute("allphone")%>';
	var caseidhuadan = '<%=request.getAttribute("caseid")%>';
	var casenamehuadan = '<%=request.getAttribute("casename")%>';
			...
			function showBigPic(){
				var imgRotate = document.getElementById("imgRotate");
			     if(bigPicFlag==0){
			        ...
			        $("#main_d5 canvas").css("height","700px");
			       ...
			       // ContactAnalysis_d5();
			        ...
			        $("#main_d52").css("display","");
			        $("#main_d5").css("display","none");
			        ...
			        ContactAnalysis_d5();
			    	 ...
			    	 $("#main_d5 canvas").css("height","400px");
				     $("#main_d5").find("div").css("height","400px")   
						      
				        $("#callList_d5").css("display","");
				     $("#main_d52").css("display","none");
				        $("#main_d5").css("display","");
			    	 bigPicFlag=0;
			    	 ContactAnalysis_d5();
			     }
			...
			function Exporthd_each(){
				...
				var startDate =document.getElementById('startTime_1').value;  //开始日期
				var endDate =document.getElementById('endTime_1').value;  //结束日期
			//	alert(nums_eachticket);
				//确认导出
				...
				"suspectNumsStr":suspectPhoneStr,
					*/
					$("#url12_d5").attr("href","<%=basePath %>admin/Exporthd_each.php?suspectPhoneStr="+suspectPhoneStr+"&caseidStr="+caseidStr+"&caseName13="+caseName13+"&startDate="+startDate+"&endDate="+endDate+"&count="+nums_eachticket+"&haoma="+haoma); 
			...
			function select_d4(){	//d4嫌疑人选项
				$("#select_d4").empty();
				var CaseInfoTemp = document.getElementsByName("ids");
				var CaseInfo=[];
				for(var i=0;i<CaseInfoTemp.length;i++){
					for(var j=0;j<document.getElementsByName("ids_call"+i).length;j++)
						CaseInfo.push(document.getElementsByName("ids_call"+i)[j]);
				}
	...
	var choiceType=0;
		...
		function d1() {
		 ...
		 // 清空d7 中的搜索条件
   			$("#startTime_1").val("");
   			$("#endTime_1").val("");
   			$("#StatisticsSuspectName").val("");
   			$("#StatisticsContactorNumber").val("");
			$("#d20").hide();
			showAllTicket(1)
			choiceType=1;
		}
        ...
        function showAllFile2(pageno){
            ...
            $.ajax({
                ...
                success : function(data) {
                    ...
                    if(pagesum<sizes){
                        var html2 = '<li class="active" id="orderA"><a href="javascript: void(0);" onclick="showAllFile2(1)">1</a></li >';
                        $("#pagesA").after(html2);
                            ...
                            if(pageno+length-1<=pagenum){
                                ...
                                if(pageno-2>0){
                                    for(var i =pageno-2;i<=pageno+length-1-2;i++){
                                        if(i==pageno)
                                            html2 += '<li class="active" id="orderA"><a href="javascript: void(0);" onclick="showAllFile2('+i+')">'+i+'</a></li >';
                                        else

                                            html2 += '<li id="orderA"><a href="javascript: void(0);" onclick="showAllFile2('+i+')">'+i+'</a></li >';
                                    }
                                }
                                else{
                                    for(var i =1;i<=length;i++){
                    ...
                    var html5 = '<a href="javascript: void(0);" onclick="showAllFile2('+pageno+'-1<1?1:'+pageno+'-1)"><</a>';
                    $("#pages11").append(html5);

                    var html4 = '<a href="javascript: void(0);" onclick="showAllFile2('+pageno+'+1>'+pagenum+'?'+pagenum+':'+pageno+'+1)">></a>';
...
//window.onload = showAllTicket_d5(1,0);
		...
		/* 	if(pageno==1&&flag_showAllTicket_d5==1){
			...
			$.ajax({
				...
				success : function(data) {
					...
					if(pagesum<sizes){
						var html2 = '<li class="active" id="order_d5"><a href="javascript: void(0);" onclick="showAllTicket_d5(1,0)">1</a></li >';
					...
					if(pageno<pagenum){
						if(pageno+length-1<=pagenum){
							...
							if(pageno-2>0){
								for(var i =pageno-2;i<=pageno+length-1-2;i++){	
									if(i==pageno)
										html2 += '<li class="active" id="order_d5"><a href="javascript: void(0);" onclick="showAllTicket_d5('+i+',0)">'+i+'</a></li >';
										else
							
											html2 += '<li id="order_d5"><a href="javascript: void(0);" onclick="showAllTicket_d5('+i+',0)">'+i+'</a></li >';  
							   				   }
								}
							else{
								for(var i =1;i<=length;i++){	
					...
					var html5 = '<a href="javascript: void(0);" onclick="showAllTicket_d5('+pageno+'-1<1?1:'+pageno+'-1,0)"><</a>';
					$("#pages1_d5").append(html5);
					
					var html4 = '<a href="javascript: void(0);" onclick="showAllTicket_d5('+pageno+'+1>'+pagenum+'?'+pagenum+':'+pageno+'+1,0)">></a>';
					$("#pages2_d5").append(html4);
					$("#tbcont20_d5").empty();
					$.each(Ticket,function(i,item){
						var html01 = '+<tr>'+
						'<td  id="suspectcost_d5" name="suspectcost">'+item.localNum+'</td>'+
						'<td  id="startTime_d5" name="startTime">'+item.startTime+'</td>'+
						'<td  id="dialNumber_d5" name="dialNumber">'+item.dialNumber+'</td>'+
						'<td  id="callDuration_d5" name="callDuration">'+item.callDuration+'</td>'+
						'<td  id="position_d5" name="position">'+item.positionName+'</td>'+
						'<td  id="method_d5" name="method">'+item.method+'</td>'+
	...
	function showAllTicketCount1(pageno){
		...
		$.ajax({
			...
			success : function(data) {
				...
				if(pagesum<sizes){
					var html2 = '<li class="active" id="order"><a href="javascript: void(0);" onclick="showAllTicketCount1(1)">1</a></li >';
				...
				if(pageno<pagenum){
					if(pageno+length-1<=pagenum){
						...
						if(pageno-2>0){
							for(var i =pageno-2;i<=pageno+length-1-2;i++){	
								if(i==pageno)
									html2 += '<li class="active" id="order"><a href="javascript: void(0);" onclick="showAllTicketCount1('+i+')">'+i+'</a></li >';
									else
						
										html2 += '<li id="order"><a href="javascript: void(0);" onclick="showAllTicketCount1('+i+')">'+i+'</a></li >';  
						   				   }
							}
						else{
							for(var i =1;i<=length;i++){	
				...
				hdurl = [];
				var html5 = '<a href="javascript: void(0);" onclick="showAllTicketCount1('+pageno+'-1<1?1:'+pageno+'-1)"><</a>';
				$("#pages1Count1").append(html5);
				hdurl = [];
				var html4 = '<a href="javascript: void(0);" onclick="showAllTicketCount1('+pageno+'+1>'+pagenum+'?'+pagenum+':'+pageno+'+1)">></a>';
				...
				$.each(Ticket,function(i,item){
					...
					var html01 = '+<tr>'+ 
										'<td style="text-align:left;" id="startTime" name="startTime">'+item.startTime+'</td>'+
										'<td style="text-align:left;" id="startTime" name="startTime">'+item.name+'</td>'+
										'<td style="text-align:left;" id="startTime" name="startTime">'+item.localNum+'</td>'+
										'<td style="text-align:left;" id="dialNumber" name="dialNumber">'+item.dialNumber+'</td>'+
										'<td style="text-align:left;" id="callDuration" name="callDuration">'+array+'</td>'+
										'<td style="text-align:left;" id="position" name="position">'+item.position+'</td>'+
										'<td style="text-align:left;"id="method" name="method">'+item.method+'</td>'+
										'<td style="text-align:left;" id="huadanid'+i+'" name="huadanid" style="display:none;>'+item._id+'</td>'+
								'</tr>+';
	...
	///////////////////////////////////////////////////////	
		...
		function exportFile() {
            ...
            if (rs) {
                ...
                $("#url12").attr("href", "javascript:void(0)");
            }

		}

		function exportFile_div2() {
            var rs = confirm("确定导出?");
            if(rs) {
                    $("#url13").attr("href","<%=basePath %>admin/ExporthdContacts.php?getlinkmanJSP="+getlinkmanJSP);
            } else {
                	$("#url13").attr("href", "javascript:void(0)");
			}
		}
	...
	function showAllTicket(pageno){
		...
		var givePages_huadanfenxi_button = $("#givePages_huadanfenxi_button").val();
    	if(givePages_huadanfenxi_button != ""){
    		pageno = parseInt(givePages_huadanfenxi_button);
    	}
        Ticket();
		$.ajax({
			type : "POST",
			...
			success : function(data) {
				...
				var sizes=5;
				var pagesum=data.total;
				nums_eachticket=data.total;//导出时有用到
				var pagenum = pagesum / sizes;
				var length=5;  //要显示的分页页数
				eachticket=data.total;
				if(pagenum%1!=0){
				...
				if(pageno<pagenum){
					if(pageno+length-1<=pagenum){
						...
						if(pageno-2>0){
							for(var i =pageno-2;i<=pageno+length-1-2;i++){	
								if(i==pageno)
									html2 += '<li class="active" id="order"><a href="javascript: void(0);" onclick="showAllTicket('+i+')">'+i+'</a></li >';
									else
										html2 += '<li id="order"><a href="javascript: void(0);" onclick="showAllTicket('+i+')">'+i+'</a></li >';  
						   				   }
							}
						else{
							for(var i =1;i<=length;i++){	
				...
				$("#main_pages2").empty();
				var html3 ='<span >共'+pagesum+'条，当前'+pageno+'/'+pagenum+'页</span>';
				$("#main_tot").append(html3);
				hdurl = [];
				var html5 = '<a href="javascript: void(0);" onclick="showAllTicket('+pageno+'-1<1?1:'+pageno+'-1)"><</a>';
				$("#main_pages1").append(html5);
				hdurl = [];
				var html4 = '<a href="javascript: void(0);" onclick="showAllTicket('+pageno+'+1>'+pagenum+'?'+pagenum+':'+pageno+'+1)">></a>';
				...
				$.each(Ticket,function(i,item){
					...
					var html01 = '+<tr>'+
										'<td style="text-align:left;" id="startTime" name="startTime">'+item.startTime+'</th>'+
										'<td  style="text-align:left;"id="startTime" name="startTime">'+item.name+'</th>'+
										'<td style="text-align:left;" id="startTime" name="startTime">'+item.localNum+'</th>'+
										'<td style="text-align:left;" id="dialNumber" name="dialNumber">'+item.dialNumber+'</th>'+
										'<td style="text-align:left;" id="callDuration" name="callDuration">'+array+'</th>'+
										'<td style="text-align:left;" id="position" name="position">'+item.position+'</th>'+
										'<td style="text-align:left;" id="method" name="method">'+item.method+'</th>'+
										'<td style="text-align:left;" id="huadanid'+i+'" name="huadanid" style="display:none;>'+item.id+'</td>'+
								'</tr>+';
					$("#tbcont20").append(html01);
					hdurl.push(item._id);
				});
				$("#givePages_huadanfenxi_button").val("");
			},
			error: function(XMLHttpRequest, textStatus, errorThrown) {
				//alert("失败");
			}
...
function ContactAnalysis(){
	var startDate222 =document.getElementById('startDate222').value;
	var endDate222 =document.getElementById('endDate222').value;
				...
				$.each(ticketLinksList,function(i,item){
					...
					if(item.linkman=="" || localNum==""){
						...
						var html1='<tr data-toggle="modal" id="linkid'+i+'" data-target="#myModal"'+
							...
							'<td style="text-align: left" id="td1'+i+'">'+item.linkman+'</td>'+
							'<td style="text-align: right" id="td2'+i+'">'+localNum+'</td>'+
								'<input type="hidden" id="getLinkmanParam'+i+'" value="'+item.linkman+'">'
						'</tr>';
    			...
    			var nodes=[];
					$.each(data.aliketickets,function(i,item4){
						...
						if(flag==0){
							var node1={
								    name: localNum5,
								    symbol: 'image://<%=basePath%>/template/img/head_suspect.png',
								    itemStyle: {
								        normal: {
								            color: '#f90', //圆点的颜色
								            label: {
...
function searchone(i){
    $("#testDiv"+i).addClass("tintage");
    if(i == getId) {
//            $("#labelInfo"+id).toggleClass("mycolor");
        $("#td1"+i).css("background-color","#dee9f4");
        $("#td2"+i).css("background-color","#dee9f4");
    } else {
        $("#td1"+i).css("background-color","#dee9f4");
        $("#td2"+i).css("background-color","#dee9f4");
        $("#td1"+getId).css("background-color","");
        $("#td2"+getId).css("background-color","");
        getId = i;
    }

    getlinkmanJSP = $("#getLinkmanParam"+i).val();
	...
	//解封lyxg— —插件显示
		function ContactAnalysis_d5(){
			var CaseInfo = document.getElementsByName("ids_call");
			var tonghuacishu =document.getElementById('tonghuacishu').value;
		    var suspectNums = [];
		     var suspectNumsStr="";
		     var caseId="";
		    for(i=0;i<CaseInfo.length;i++){
...
//点击事件    
myChart_d5.on("click",function(params){
	
	var haoma = params.name;
...
if(bigPicFlag==1)
	myChart_d52 = echarts.init(document.getElementById('main_d52'));
...
////////////////d5_通话记录显示////////////////////////////////////
					...
					$.each(ticketLinksList,function(i,item){
						...
						var licketLinkList = item.licketLinkList;
						var localnumList=data.localnumList;
						 linksnum=nodesnum;
						nodesnum=nodesnum+1;
						...
						$.each(licketLinkList,function(j,item2){
							var dialNumber = item2.dialNumber;
							var number = item2.number;
					if(tonghuacishu!=null && tonghuacishu!=""){	
						if(parseInt(number)>=parseInt(tonghuacishu)){
							if(flag_55==0){
							...
							//判断对方号码是否为嫌疑人号码中的一个，如果是则不创建节点
							flag_local=0;//判断是否为共同联系人
							$.each(localnumList,function(i,item_local){
								if(item_local==dialNumber){
									flag_local=1;
									return false;
...
/* myChart_d52.setOption(option); */
						...
						$.each(licketLinkList,function(j,item2){
							...
							count++;
				                    var html = '+<tr id="tbody_d4" style="text-align: left" onclick="getCallRecord('+item2.localNum+','+item2.position+','+item2.number+')">'+
				                        ...
				                        '<td><a href="javascript:void(0)"  onclick="searchByLatAndLon('+item2.lat+','+item2.lon+')">'+item2.positionName+'</a></td> '+
	    ...
	    function getCallRecord(localNum,pid1,pid2,number){
			...
			if(caseId==null||caseId==""){
					caseId=document.getElementsByName("ids_call0")[0].alt;
			}
			$.ajax({
				type : "POST",
	...
	//    window.onload = addressMap();
	    var CASEID_FLAG_D6;//与CASEID_FLAG同作用
			...
			$.ajax({
				...
				success : function(data) {
					...
					$.each(ticketLinksList,function(i,item){
						...
						$.each(licketLinkList,function(j,item2){
							if(j<4){
							//	if(item2.positionName!="")  根据前三个地点的地名在地图上标记（旧），地点按通话次数排序
							//		addrs.push(item2.positionName_sim);
								if(item2.lat!=""&&item2.lat!=" ")   //根据前三个地点的经纬度在地图上标记（新），地点按通话次数排序
									addrs.push(item2.lat+"-"+item2.lon);
							}
	...
	function showcase(){
		...
		$.ajax({
			...
			success : function(data) {
				$("#tbcont").empty();
				var htmlhead='<tr>'+
					'<td class="td_right"><input type="checkbox" id="ckall" onclick="selectAll()"/></td>'+
					'<td class="td_right">案件编号</td>'+
					...
					if(mainParty2.length>0){
						$.each(mainParty2,function(j,item){
							...
							htmlMainParty+='<tr name="caseSuspect'+i+'" style="display: none;">'+
												...
												'<td class="td_right" id="sus'+i+'j'+j+'" >'+
													'<input alt="'+caseId+'" id="'+mainPartyName+'"  name="ids_call'+i+'" value="'+mainPartyCall+'" type="checkbox"  onclick="selectSusp('+i+','+j+','+mainPartyCall+');" />'+
													'<span style=" margin-left: 20px; ">嫌疑人：'+mainPartyName+'</span>'+
													'</td>'+
												'<td class="td_right">号码：'+mainPartyCall+'</td>'+
				...
				/*     for(var i=0;i<ck.length;i++){
					...
					if(caseflag==1){
						html += '<tr>'+
						'<td class="td_right"><input id="caselist'+i+'" type="checkbox"  checked="checked" name="ids" value="'+item.caseName+' '+item.id+'" onclick="selectCase('+i+');" />'+
						'<td class="td_right">'+item.caseNum+'</td>'+
					...
					html += '<tr>'+
							'<td class="td_right"><input id="caselist'+i+'" type="checkbox" name="ids" value="'+item.caseName+' '+item.id+'" onclick="selectCase('+i+');" />'+
							'<td class="td_right">'+item.caseNum+'</td>'+
							'<td class="td_right" id="">'+item.caseName+'</td>'+
							'<td class="td_right" id=""  onclick="shuoSuspect('+i+')"><img id="imgRotate'+i+'" class="menu_arrow" alt="" src="<%=basePath%>template/img/018.png" style="transform:;" /></td>'+
						'</tr>'+htmlMainParty;
	...
	function selectAll(){
 	...
 	//选择嫌疑人
	function selectSusp(a,b,call){
		var ckall=document.getElementById("sus"+a+"j"+b).children[0];
		if(ckall.checked){
    		if(suspectPhoneStr==""){
            	suspectPhoneStr=call;
            }else{
            	...
            	if(flagsus==0){
            		suspectPhoneStr=suspectPhoneStr+","+call;
            	}
            }
    	}else{
    		var suspectPhoneStrSplit=suspectPhoneStr.split(",");
	...
	function panduan(){
		...
		if(caseidhuadan%1 === 0){
			...
			caseidStr = caseidhuadan;
			
			var html ='<span class="br05 b12 span-1" id="shanchu2'+caseidStr+'" style="width: 150px; height: 30px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-right: 15px;margin-top: 5px;" onclick="deletemainParty(this.id,'+caseidStr+')">'+casenamehuadan+
		...
		if(re.test(allphone) || allphone.indexOf(",")>0){
			suspectPhoneStr = allphone;
		}
	}
	...
	function checkCase(obj){
	    ...
	    <%-- for(i=0;i<CaseInfo.length;i++){
	        ...
	        if(CaseInfo[i].checked){
	            ...
	            //append到页面
		        var html ='<span class="br05 b12 span-1" id="shanchu2'+i+'"  style=" height: 30px;margin-right: 15px;margin-top: 5px;" onclick="deletemainParty(this.id,'+CaseInfo[i].value.split(" ")[1]+','+i+')">'+CaseInfo[i].value.split(" ")[0]+
				'<img  src="<%=basePath%>template/img/x.png" /></span><span id="suspectnum'+i+'" style=" display:none;">'+sus+'</span>';
				$("#spans").append(html);
				anjiansum=1;
	        }
 
	    } --%>
	    //如果没有选案件 只选择嫌疑人 把嫌疑人关联的所有案件展示出来
	     
	    if(caseidStr=="" && suspectPhoneStr!=""){
	    	$.ajax({
			type : "POST",
			url : "<%=basePath%>admin/getCaseOfEmail.php",
			data : {
			...
			async: true,
			success : function(data) {
				var sustr=suspectPhoneStr+"";
				var suspectidList=sustr.split(",");
				$.each(data,function(i,item){
				 	var mainParty = item.mainParty;
				 	var flag1=0;
				 	$.each(suspectidList,function(i,susid){
					 	if(mainParty.indexOf(susid) >= 0 ) {
					 		flag1=1;
						}
				 	});
				 	if(flag1==1){
				 		 var html2 ='<span class="br05 b12 span-1" id="shanchu2'+item.id+'"  style="width: 150px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;height: 30px;margin-right: 15px;margin-top: 5px;" onclick="deletemainParty(this.id,'+item.id+')">'+item.caseName+
							'<img style="float: right; margin-right: 5px; margin-top: 7px;" src="<%=basePath%>template/img/x.png" /></span><span id="suspectnum'+item.id+'" style=" display:none;">'+mainParty+'</span>';
							$("#spans").append(html2);
				 	}
				});
			  }
	...
	function deletemainParty(id,caseId){
		...
		//for(var j=0;j<susSplit.length;j++){
			...
			if(suspectStrNew==""){
				...
				var phtone = "";
				var suspectStrNewsplit = suspectStrNew.split(",");
				if(suspectStrNewsplit.length>0){
					for(var i=0;i<suspectStrNewsplit.length;i++){
						var ssnl = suspectStrNewsplit[i];
						if(sus.indexOf(ssnl)==-1){
							if(phtone==""){
								phtone=ssnl;
							}else{
								phtone=phtone+","+ssnl;
	...
	function showAllTicketCount(pageno){
		...
		$.ajax({
			...
			success : function(data) {
				...
				if(pagesum<sizes){
					var html2 = '<li class="active" id="order"><a href="javascript: void(0);" onclick="showAllTicketCount(1)">1</a></li >';
				...
				if(pageno<pagenum){
					if(pageno+length-1<=pagenum){
						...
						if(pageno-2>0){
							for(var i =pageno-2;i<=pageno+length-1-2;i++){	
								if(i==pageno)
									html2 += '<li class="active" id="order"><a href="javascript: void(0);" onclick="showAllTicketCount('+i+')">'+i+'</a></li >';
									else
						
										html2 += '<li id="order"><a href="javascript: void(0);" onclick="showAllTicketCount('+i+')">'+i+'</a></li >';  
						   				   }
							}
						else{
							for(var i =1;i<=length;i++){	
				...
				var html5 = '<a href="javascript: void(0);" onclick="showAllTicketCount('+pageno+'-1<1?1:'+pageno+'-1)"><</a>';
				$("#pages1Count").append(html5);
				
				var html4 = '<a href="javascript: void(0);" onclick="showAllTicketCount('+pageno+'+1>'+pagenum+'?'+pagenum+':'+pageno+'+1)">></a>';
				...
				$.each(Ticket,function(i,item){
					...
					'<td style="text-align:left;" id="startTime" name="startTime">'+item.localNum+'</th>'+
					'<td style="text-align:left;"id="dialNumber" name="dialNumber">'+item.dialNumber+'</th>'+
					'<td  style="text-align:left;"id="callDuration" name="callDuration">'+item.callDuration+'</th>'+
					'<td  style="text-align:left;"id="position" name="position">'+item.position+'</th>'+
					'<td style="text-align:left;"id="method" name="method">'+item.method+'</th>'+
				    '</tr>+';
...
//	       案件名联想
	...
	//回车搜索事件   跳页
	function onKeyDown_fenxi(event){
	   var e = event || window.event || arguments.callee.caller.arguments[0];
	   if(e && e.keyCode==13){ // enter 键
		   showAllTicket(1);
	   }
	...
	//回车搜索事件   更改案件
	function onKeyDown_huadan(event){
	   var e = event || window.event || arguments.callee.caller.arguments[0];
	   if(e && e.keyCode==13){ // enter 键
		   showcase(1);
	   }
