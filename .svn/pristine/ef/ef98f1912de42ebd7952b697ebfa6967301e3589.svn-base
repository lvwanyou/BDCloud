...
.datagrid-body::-webkit-scrollbar{
	...
	.red{color:#329933 !important;}		/* 暂存归档 */
	.yellow{color:#0000CE !important;}/* 未处置 */
	.green{color:#999900 !important;}/* 积累归档 */
	.blue{color:#FF6768 !important;}  /* 线索经营 */
	.black{color:#FF9A00 !important;} /* 线索转出 */
	.shixiao{color:#993267 !important;} /* 已失效 */
	.lian{color:#020000 !important;} /* 已情报立案 */
				...
				<div class="panel-heading">搜索</div>
					...
					<div class="panel-body" id="searchOfForm" style="display: block;">
						...
						<!-- 	<div class="form-group">
							...
							<div class="form-group">
									<label for="" class="clabel">时间搜索:</label>
						...
						<table id="datatable" class="table table-striped table-hover br04" style="text-align: center;">
							<thead>
								<tr>
									...
									<th class="alcenter" style="width: 6%;text-align:left;">线索类型</th>
									<th class="alcenter" style="width: 8%;text-align:left;">线索接受时间</th>
									<th class="alcenter" style="width: 6%;text-align:left;">作案时间</th>
...
/* 					var falg = 0;
					...
					var red = "";
					 ...
					 $("#tbcont").append(
										...
										'<td onclick="getidss('+res[i].id+')" style="text-align:left;"><p onclick="getidss('+res[i].id+')" style="width: 100px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">'+res[i].threadType+'</p></td>'+
										'<td onclick="getidss('+res[i].id+')" style="text-align:left;><p style="width: 100px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">'+res[i].threadAcceptDate+'</p></td>'+
										'<td onclick="getidss('+res[i].id+')" style="text-align:left;><p style="width: 100px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">'+res[i].crimeDate+'</p></td>'+
										'<td onclick="getidss('+res[i].id+')" >'+res[i].threadSource+'</td>'+
										/* '<td onclick="getidss('+res[i].id+')" >'+res[i].susItem+'</td>'+ */
										'<td onclick="getidss('+res[i].id+')" id="agreeStatuss1'+res[i].id+'" style="display:none;">'+res[i].agreeStatus+'</td>'+
/* 										'<td onclick="getidss('+res[i].id+')" ><p style="width: 140px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">'+res[i].createdTime+'</p></td>'+ */
										'<td onclick="getidss('+res[i].id+')" >'+res[i].reportPerson+'</td>'+
									 	'<td onclick="getidss('+res[i].id+')" >'+res[i].userPartment+'</td>'+ 
									 	
										'<td onclick="getidss('+res[i].id+')" ><span class="'+red+'"  id="disposalss'+i+'">'+res[i].disposal+'</span></td>'+
										/* '<td onclick="getidss('+res[i].id+')" >'+res[i].status+'</td>'+ */
										'<td onclick="getOnclick('+res[i].id+')"><span class="'+numbe+'" >'+res[i].crossNum+'</span></td>'+
										/* '<td><a href="#" class="btnA" data-toggle="modal" onclick="getid(\''+res[i].id+'\');" id="chooseIDss'+res[i].id+'">'+res[i].statuss+'</a></td>'+ */
										'<td><a href="<%=basePath%>admin/edit_person.php?id='+res[i].id+'" id="bt'+res[i].id+'" class="btnA" return onclick="xiansuo(\''+res[i].disposal+'\',\''+res[i].id+'\')">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="btnA" data-toggle="modal" onclick=" deleteid(\''+res[i].id+'\')">删除</a></td>'+
										'</tr>');
					$("#givePages_one").val("");
				}
				//$("#pageUL").html("");
...
function getOnclick(id) {
    window.location="<%=basePath %>list/repeat.php?caseid="+id;
}
