...
<body>
	...
	<div class="wrapper-md" style="height: 100%;width: 100%">
		...
		<div style="overflow:hidden">	
			<div class="panel panel-default" style="width: 47%;height:300px;float: right;margin-right:20px;">
				<div class="panel-heading">案件趋势图</div>
				<div id="list" style="height:300px;"></div>
	
	    	</div>	
	    	<div class="panel panel-default" style="width: 47%;height:300px;float: left;margin-left:20px;">
    	...
    	<div class="panel-body b22 br17" style="border-top:none;">
					<div>
				...
				<div class="col-md-10 b22" style="width:100%;">
	...
	<!-- footer -->
    		<%-- <div class="b20"  style=" text-align:center; width:100%;padding-top: 17px;padding-bottom:47px;">
			<img style=" margin-top:20px;" src="<%=basePath%>template/img/footer.png">
			<img  src="<%=basePath%>template/img/left.png"><span class="c08" style="font-size:12px;margin: 0 12px;">  由勋立云计算提供技术支持  版本号: V1.1.1082  </span><img src="<%=basePath%>template/img/left2.png">
			</div> --%>
