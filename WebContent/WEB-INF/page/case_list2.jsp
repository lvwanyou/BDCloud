...
//	var username = '${user.username}';//获取当前登陆用户  privilege
	...
	$("#editCaseA").attr("href","<%=basePath %>admin/edit_case2.php?id="+id);
	 // $("#mainParty").empty();
	$.ajax({
...
function getid() {
	...
	window.location.href = "<%=basePath %>getEvidencelist2.php?evid="+evid;
}
function youjian() {
	var caseid;
...
//	if((caseNum==null||caseNum.length==0)&&(caseName==null||caseName.length==0)&&(casestatus==null||casestatus.length==0)&&(a==null||a.length==0)&&(b==null||b.length==0)&&(c==null||c.length==0)&&(d==null||d.length==0)&&(e==null||e.length==0)&&ids.length==0){
		geturl=	"<%=basePath %> getcaselist_refresh2.php";
		 getdata={
				 	"pageno" : pageno,
					"caseNum" : caseNum,
					"caseName" : caseName,
		...
		<div class="col-md-12" style="margin-bottom:27px;">
			<div class="row">
						...
						<form class="form-inline" role="form" id="searchForm" name="form1"
							...
							<%-- <div class="form-group" style="width: 22%;">
								<label for="" class="clabel">案件状态:</label> <select
									class="form-control addWid"
									style="color: #BFA6A6; width: 60%; border-radius: 2px;"
							...
							<button type="button" class="btn btn-info" style="width: 75px; height: 30px; background-color: #475E9C; color: #fff;"
							...
							<div id="hidden" style="display: none;">
								...
								<div class="form-group" style="width: 22%">
									<label for="" class="clabel">案件类型:</label> <select
										class="form-control"
										style="width: 60%; color: #BFA6A6; margin-left: -4px;"
				...
				<div class="" style="margin-bottom: 15px;">
					<a href="<%=basePath%>admin/newcase.php" class="btn w-xs btn-info" style="margin-right: 30px;">新建案件</a>
				</div> 
			</div>
				...
				<div class="modal-content">
					<div class="panel panel-default" style="padding-right: 10px;">
						<div class="panel-body" style="overflow-y: auto; height: 750px;">
							...
							<div class="panel-heading" style="padding: 10px; background-color: #fff; border: 1px solid #DDDDDD;">涉案物品</div>
					...
					<div style="text-align: center;">
	 					<div class="">
							...
							<a href="<%=basePath%>admin/edit_case2.php" class="btn" id="editCaseA"
