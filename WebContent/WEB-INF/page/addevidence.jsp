	...
	<div class="wrapper-md">
		<div class="col-md-12" style="margin-bottom:27px;">
			...
			<div class="" style="text-align: left; margin-bottom: 20px; margin-top: 20px;">
				<a href="<%=basePath%>admin/importevidence.php" type="button"
						...
						<tbody id="tbcont">
							<c:forEach items="${logs }" var="ev">
								<tr>
									...
									<c:if test="${ev.indexFlag==0}">正在建立索引</c:if>
...
function subForm(pageno){
	...
	window.location.href = "<%=basePath%>getEvidencelist.php?evid="+evid+"&pageno="+pageno;
}
...
function getcaseId() {
	...
	$.ajax({
		type : "POST",
		url : "<%=basePath%>getCaseSummary.php",
		cache:false, 
	    async:false,  
		data : {
