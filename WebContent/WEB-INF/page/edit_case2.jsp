...
<body>
	...
	<div class="bg-light lter b-b wrapper-md">
		...
		<div class="" style="padding-left: 20px;padding-top: 15px;">
			<a href="<%=basePath%>getcaselist2.php" class="btn w-xs btn-info" style="margin-right: 30px;" onclick="return">返回</a>
		</div>
					...
					<form class="bs-example form-horizontal" id="edit_form">
						...
						<div class="form-group">
							...
							<div class="col-lg-6">
								<select class="form-control" name="status_edit" id="status_edit">
									<option>办案中</option>
									<option value="${result.status}" <c:if test="${result.status == '已结案' }"> selected="selected"</c:if> >已结案</option>
								</select>
							</div>
						</div>
						...
						<div class="form-group" style="margin-top: 54px;">
							<div class="col-lg-offset-5 col-lg-5">
								...
								<a class="btn w-xs btn-default" href="<%=basePath %>getcaselist2.php">取消</a>
							</div>
						</div>
					</form>
				</div>
...
function goCaseList() {
	window.location="<%=basePath %>getcaselist2.php";
}
