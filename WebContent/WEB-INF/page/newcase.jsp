...
<body>
					...
					<form id="form1" class="bs-example form-horizontal"
						...
						<div class="form-group">
							<label class="col-lg-3 control-label"><span
								class="im_flag c11">*</span>案件编号</label>
							<div class="col-lg-6">
								<input class="form-control" placeholder="请输入案件编号(仅支持字母加数字)" type="text"
									id="caseNum" name="caseNum" onBlur="validateCaseNum()">
						...
						<div class="form-group">
							<label class="col-lg-3 control-label"><span
								class="im_flag c11">*</span>案件类型</label>
							<div class="col-lg-6">
								<select class="form-control c21" id="caseType" name="caseType">
 ...
 -->
	                ...
	                <div class="form-group">
							<label class="col-lg-3 control-label"><span
								class="im_flag c11">*</span>案件受理日期</label>
							<div class="col-lg-6">
						...
						<div class="form-group" style="margin-top: 54px;">
							<div class="col-lg-offset-5 col-lg-5">
								<button type="submit" class="btn w-xs btn-info" data-toggle="modal" 
...
>>>>>>> .r787 */
	...
	if(bianhaoflag==0){
//		alert("请先填写正确案件编号!");
		$('#caseNumber_tanchuan').modal('show');
		return false;
	}
	if(mingchengflag==""){
//		alert("请先填写案件名称!");
		$('#caseName_tanchuan').modal('show');
		return false;
	}
	if(caseType==""){
//		alert("请选择案件类型!");
		$('#caseType_tanchuan').modal('show');
		return false;
	}
	if(acceptTime==""){
//		alert("请选择案件受理日期!");
		$('#caseData_tanchuan').modal('show');
		return false;
	}
/* 	if(renyuanflag==0){
//		alert("请填写涉嫌人员!");
		$('#casePerson_tanchuan').modal('show');
		return false;
	} */
...
//	renyuanflag=0;
	...
	var re = /^1[3|4|5|8|7][0-9]\d{8}$/; //判断字符串是否为数字 //判断正整数 /^[1-9]+[0-9]*]*$/
    var nubmer1 = num[1];
    var nubmer2 = num[2];
