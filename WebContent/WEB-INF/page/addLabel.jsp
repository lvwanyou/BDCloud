...
<body>
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									<input class="form-control" placeholder="请输入标签名" type="text"
										id="label2" name="label2" onblur="validateCaselabel()" onkeydown="if(event.keyCode==13){return false;}">
										<span id="addevlabel" class="empty c11"></span>
								</div>
							</div>
	...
	<!-- 新增标签弹窗 -->
		<div class="modal fade" id="label_tanchuan" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog" style="width: 476px;">
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h3 class="modal-title c20" id="myModalLabel" style="border-left: none;">新增标签</h3>
					</div>
					<div class="modal-body">请输入标签名称！</div>
